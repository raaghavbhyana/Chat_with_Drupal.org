...
st.set_page_config(page_title="Chat with Drupal API",page_icon="")
st.title("Chat with Drupal.org")
with st.sidebar:
    st.header("Setting")
    website_url=st.text_input("Enter api link")
    

if website_url is None or website_url=="":
    st.info("Please enter api link")
else:
           # session state
